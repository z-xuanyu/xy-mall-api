 ...
 * @LastEditTime: 2022-06-20 15:41:37
 * @Description: 产品控制器
 */
import {
  Controller,
...
export class ProductController {
  ...
  async create(@Body() createProductDto: CreateProductDto): Promise<ApiSucceedResult<Product>> {
  ...
  @ApiParam({ name: 'id', description: '商品id' })
  async updateStatus(@Param('id') id: string, @Body() paramsDto: ProductStatusDto) {
  ...
  @ApiParam({ name: 'id', description: '商品id' })
  async updateHotStatus(@Param('id') id: string, @Body() paramsDto: ProductStatusDto) {
  ...
  async batchUpdateHotStatus(@Body() batchUpdateHotStatusDto: BatchUpdateHotStatusDto) {
  ...
  @ApiParam({ name: 'id', description: '商品id' })
  async updateTimeLimitStatus(@Param('id') id: string, @Body() paramsDto: ProductStatusDto) {
